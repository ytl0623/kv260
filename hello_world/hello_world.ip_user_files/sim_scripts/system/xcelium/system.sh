...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../hello_world.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../hello_world.gen/sources_1/bd/system/ipshared/bb17/hdl" \
       +incdir+"$ref_dir/../../../../hello_world.gen/sources_1/bd/system/ipshared/6dcf" \
       +incdir+"../../../../hello_world.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../hello_world.gen/sources_1/bd/system/ipshared/bb17/hdl" \
       +incdir+"../../../../hello_world.gen/sources_1/bd/system/ipshared/6dcf" \
